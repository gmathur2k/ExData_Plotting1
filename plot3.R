...
## My inputs: data_household_power_consumption.txt, plot3.png, 01/02/2007, 02/02/2007
datfilename=readline(prompt="Enter data file name: ")
plot3filename=readline(prompt="Enter Plot 3 PNG file name: ")
...
## pngfilename
png(filename=plot3filename, width=480, height=480, units="px")
...
legend("topright", col=c("brown", "green", "blue"),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lty=c(1,1), lwd=c(2.5,2.5))
dev.off()
